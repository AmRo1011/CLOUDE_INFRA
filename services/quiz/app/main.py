...
from app.routers import quizzes, attempts
...
app = FastAPI(
    title="Quiz Service",
    description="Quiz generation and grading for Cloud Learning Platform",
    version="1.0.0",
    lifespan=lifespan
)
...
app.include_router(attempts.router, prefix="/api/quiz", tags=["Attempts"])
